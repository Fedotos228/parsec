...
export const LineArrowRight = ({ width = 24, height = 24, className }: IconProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} className={cn('transition-colors duration-300', className)} viewBox="0 0 24 24" fill="none">
