...
export const LineArrowLeft = ({ width = 24, height = 24, viewBox, className }: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} className={cn('transition duration-300', className)} viewBox={viewBox} fill="none">
