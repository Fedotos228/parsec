...
export function HeroItem(props: { video: FragmentType<typeof RepresentativeVideosFragment> }) {
  ...
  return (
    ...
    >
      ...
      <div className='absolute left-1/2 translate-y-0 -translate-x-1/2 md:-translate-x-1/2 bottom-8 lg:bottom-14 2xl:bottom-20 flex flex-col items-center gap-4 z-30 w-full px-4 text-center'>
