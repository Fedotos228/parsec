  ...
  try {
    ...
    return new ImageResponse(
      ...
      ),
      {
        ...size,
        fonts: [
          { name: 'EB Garamond', data: garamondBuf, weight: 700, style: 'normal' },
          { name: 'Hellix', data: hellixBuf, weight: 400, style: 'normal' },
        ],
      }
    )
  } catch (e: any) {
