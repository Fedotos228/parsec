...
// Forțăm randarea dinamică pentru a evita erorile la pre-renderizarea build-ului
export const dynamic = 'force-dynamic'

// Definim SVG-ul optimizat aici pentru a evita erorile de procesare a grupurilor complexe
const LOGO_SVG = `
...
export default async function Image({ params }: { params: { slug: string } }) {
  ...
  // Fonturile sunt necesare pentru branding
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Logoul integrat ca string constant */}
        <div 
          style={{ 
            display: 'flex',
            width: '120px', 
